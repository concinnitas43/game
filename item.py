...
# FILE for managing the item class
...
class Item(Obj):
    def __init__(self, x, y, s):
        ...
        self.skill = s # A string

    def display(self, surface):
        if self.skill == 'fuel': # TYPE fuel
        ...
        if self.skill == 'stop_fuel': # Stop fuel usage
        ...
        if self.skill == 'invincible': # Invincibility
